...
def find_by_id_data(request):
    ...
    mockito.when(request_handler).find_by_id('results', request.param["id"]).thenReturn(request.param['return'])
...
def find_data(request):
    ...
    # Mock up request response
    mockito.when(request_handler).find('results', request.param["params"]).thenReturn(request.param['return'])
    return request.param
...
def create_data(request):
    ...
    # Mock up request response
    mockito.when(request_handler).create('results', request.param["params"]).thenReturn(request.param['return'])
    return request.param
...
def update_data(request):
    ...
    # Mock up request response
    mockito.when(request_handler).update('results', request.param["id"], request.param["params"]).thenReturn(request.param['return'])
    return request.param
