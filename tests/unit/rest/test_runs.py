...
def find_by_id_data(request):
    ...
    mockito.when(request_handler).find_by_id('runs', request.param["id"]).thenReturn(request.param['return'])
...
def find_data(request):
    ...
    # Mock up request response
    mockito.when(request_handler).find_runs(request.param["parent_entity"], request.param["parent_entity_id"], request.param["params"]).thenReturn(request.param['return'])
    return request.param
